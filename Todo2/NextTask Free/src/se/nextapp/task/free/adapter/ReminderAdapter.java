package se.nextapp.task.free.adapter;

import java.util.ArrayList;
import java.util.Calendar;

import se.nextapp.task.free.R;
import se.nextapp.task.free.animation.CollapseAnimation;
import se.nextapp.task.free.dialog.date_and_time.DateAndTimeDialog;
...
public class ReminderAdapter extends BaseAdapter {
	...
	public ReminderAdapter(TaskView tv) {
		...
		strings.add("1 " + r.getString(R.string.hour) + " " + r.getString(R.string.before_due));
		strings.add("2 " + r.getString(R.string.hours) + " " + r.getString(R.string.before_due));
		strings.add("1 " + r.getString(R.string.day) + " " + r.getString(R.string.before_due));
		strings.add("2 " + r.getString(R.string.days) + " " + r.getString(R.string.before_due));
		strings.add("1 " + r.getString(R.string.week) + " " + r.getString(R.string.before_due));
		strings.add("2 " + r.getString(R.string.weeks) + " " + r.getString(R.string.before_due));
		strings.add("1 " + r.getString(R.string.month) + " " + r.getString(R.string.before_due));
		values.add(-1L);
		values.add(-2L);
		values.add(3600 * 1L);
		values.add(3600 * 2L);
